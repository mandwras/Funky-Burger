    ...
    <div className="p-8 flex-col relative">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="px-6 py-3 bg-emerald-500 rounded-lg text-white font-semibold text-lg hover:bg-emerald-600 transition-all duration-200 sm:absolute sm:left-8 sm:top-8 flex items-center justify-center"
        >

          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="filter" className="w-4 h-4">
